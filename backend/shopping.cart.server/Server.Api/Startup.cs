...
using Server.Common.Middleware;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // services.AddResponseStatusFilterExtension();
            ...
            services.AddMappingProfileExtension();
            services.AddLocalizationResourcesExtesnion();
            services.AddConfigurationExtenison(Configuration);
